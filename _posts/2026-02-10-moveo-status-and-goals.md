...
## Early challenges
It turns out that late 2025, STMicroelectronics updated their entire framework - which threw me for a loop. I previously enjoyed using CubeIDE with integrated CubeMX for configuring pins and peripherals. ST decided to split the two, which probably makes sense, I also understand that at the same time they improved their support for using VS Code as the development IDE. It took me an entire weekend of debating and experimenting before I was able to compile code and upload it to the Octopus in a easy and reliable manner. I fought through a couple of different options:
 - STM32CubeIDE 2.0
 - Platformio
 - Arduino IDE
